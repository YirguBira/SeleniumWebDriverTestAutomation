...
public class CommonAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
                      @Optional("OS X") String os,@Optional("10") String os_version, @Optional("chrome") String browserName, @Optional("34")
                              String browserVersion, @Optional("http://www.netflix.com") String url)throws IOException {
        System.setProperty("webdriver.chrome.driver", "/Users/IDEAProjects/MyProjects/SeleniumWebDriverTestAutomation/Generic/browser-driver/chromedriver");
        if(useCloudEnv==true){
